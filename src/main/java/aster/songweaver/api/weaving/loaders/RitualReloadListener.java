package aster.songweaver.api.weaving.loaders;
    ...
    public void reload(ResourceManager manager){
        ...
        for (Identifier id : manager.findResources(
            ...
            try {
                ...
                id = new Identifier(id.toString().replace("rituals/", ""));
                ...
                ItemStack display = JsonParserUtil.parseDisplayItem(json);

                RitualDefinition ritual = new RitualDefinition(
                        pattern, ritualId, ingredients, requirements, drawbacks, data, duration, tickInterval, display
                );

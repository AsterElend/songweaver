...
import static aster.songweaver.api.cast.SongweaverPackets.sendFeedback;

public class MoonPhaseRitual implements Ritual {
    @Override
    public void ritualCast(ServerWorld world,@Nullable ServerPlayerEntity caster, GrandLoomBlockEntity loom, @Nullable JsonObject ritualData) {

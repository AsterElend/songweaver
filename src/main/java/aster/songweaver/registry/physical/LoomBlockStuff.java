...
public class LoomBlockStuff {
    public static final List<Block> LOOM_BLOCKS = new ArrayList<>();
    ...
    public static final Block GRAND_LOOM = registerBlock("grand_loom", new GrandLoomBlock(FabricBlockSettings.copyOf(Blocks.WARPED_PLANKS)));
...
public static void init(){
        LOOM_BLOCKS.remove(RIFT_BLOCK);
        LOOM_BLOCKS.remove(LIGHT_ORB);
}
}
